...
class ModalDocentesJurado extends Component
{
    public $escuela;
    public $search;
    ...
    public function enviarDocenteJurado($id)
    {
        $this->emit('enviarDocenteJurado', Docente::find($id));
    }
    ...
    public function render()
    {
        ...
        return view('livewire.ttpp.registro.modal-docentes-jurado', compact('docentes'));
    }
}
