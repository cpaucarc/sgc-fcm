<div>
    ...
    <x-jet-dialog-modal wire:model="abrir">
        ...
        <x-slot name="content">
            ...
            <div class="my-6 space-y-4">
                <div class="px-2 py-4 bg-gray-100 rounded-lg text-center">
                    ...
                    <select wire:model="requisitoSeleccionado" id="requisito" class="input-form font-bold pr-4 w-3/5">
                ...
                <div class="px-2 py-4 rounded-lg">
                    ...
                    <input type="file" wire:model="archivo" class="input-form w-full px-4 py-6 border-dashed">
        ...
        <x-slot name="footer">
            ...
            <x-jet-button wire:click="guardarDocumento" wire:target="guardarDocumento, archivo"
