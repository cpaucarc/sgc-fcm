<div>
    @if ($estudiante != null)
        ...
        @if ($estudiante->solicitudConvalidacion)
            @if ($estudiante->solicitudConvalidacion->documentos->count())
                ...
                <x-table>
                    ...
                    <x-slot name="body">
                        @foreach ($estudiante->solicitudConvalidacion->documentos as $i => $doc)
        ...
        @else
            <div class="grid place-items-center">
                ...
                <div class="flex gap-x-6 items-center">
                    ...
                    <img class="w-48" src="{{ asset('images/ilustraciones/enviar_documento.svg') }}"
