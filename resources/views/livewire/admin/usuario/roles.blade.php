<div>
    ...
    <x-table>
        ...
        <x-slot name="body">
            @foreach($usuario_actual->roles as $i => $rol)
    ...
    <x-jet-dialog-modal wire:model="abrir">
        ...
        <x-slot name="title">
            <h1 class="font-bold">
                Asignar un nuevo rol a este usuario
            </h1>
        ...
        <x-slot name="content">
            ...
            <div class="mb-4 bg-gray-50 p-4 rounded">
                ...
                <select class="input-form w-full" wire:model="entidad_seleccionada">
                    @foreach($entidades_faltantes as $entidad)
