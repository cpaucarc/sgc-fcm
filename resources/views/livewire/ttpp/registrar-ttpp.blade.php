                ...
                <x-card>
                    <div class="space-y-6">
                        <div>
                            ...
                            <x-jet-input-error for="numeroRegistro"></x-jet-input-error>
                        </div>
                        <div>
                        ...
                        <div class="flex justify-between items-center gap-x-8">
                            <div class="w-full">
                                ...
                                <x-jet-input-error for="tipoTesis"></x-jet-input-error>
                            </div>
                            <div class="w-full">
                                ...
                                <x-jet-input-error for="anio"></x-jet-input-error>
                            </div>
                        </div>
                        <div class="flex justify-between items-center gap-x-8">
                            <div class="w-full">
                                ...
                                <input wire:model.defer="fechaSustentacion" type="date" id="fechaSustentacion"
                                       class="input-form w-full col-span-2">
                                <x-jet-input-error for="fechaSustentacion"></x-jet-input-error>
                            </div>
                            <div class="w-full">
                                ...
                                <x-jet-input-error for="declaracion"></x-jet-input-error>
                            </div>
                        </div>
                        <div>
                ...
                <x-card>
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-jet-input-error for="asesor"></x-jet-input-error>
                        </div>
                ...
                <x-card>
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-jet-input-error for="bachiller"></x-jet-input-error>
                        </div>
                        {{-- Docente Jurado --}}
                        <div>
                            ...
                            <x-jet-input-error for="jurado"></x-jet-input-error>
                        </div>
                    </div>
                    <x-slot name="footer">
                        <div class="group flex items-start gap-x-4 text-gray-500">
