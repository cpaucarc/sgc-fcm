        ...
        <x-jet-dialog-modal wire:model="mostrar" maxWidth="xl">
            <x-slot name="title">
                <h1 class="text-lg font-bold tracking-wide text-gray-800">
                    ...
                    desde {{ $fecha_medicion_inicio }} hasta {{ $fecha_medicion_fin }}
                    Medicion {{ $indicador->frecuencia->nombre }} periodo
                    cada {{ $indicador->frecuencia->tiempo_meses }}
                </h1>
            ...
            <x-slot name="content">
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-4 bg-blue-50 rounded-lg space-y-4 bg-red-600">

                        <div class="bg-yellow-300 p-6">
                            <input wire:model="fecha_medicion_inicio"
                                class="px-0 py-0 input-form-none w-min bg-transparent text-blue-700" type="date">
                        </div>

                        <div class="grid grid-cols-3 gap-x-4">
                            <div class="col-span-1">
                                <x-jet-label>{{ $indicador->titulo_interes }}</x-jet-label>
                                <input value="{{ round($interes, 1) }}" class="input-form w-full bg-gray-100"
                                    readonly>
                            </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg space-y-4">
                        <div>
                            ...
                            <input type="text" wire:model.defer="elaborador"
                                class="input-form w-full placeholder-gray-400" placeholder="Ej. Dr. John Doe">
                        </div>
                        <div>
            ...
            <x-slot name="footer">
                ...
                <x-jet-button wire:click="guardarInstancia" wire:target="guardarInstancia"
                    wire:loading.class="bg-gray-800" wire:loading.attr="disabled">
                    <svg wire:loading wire:target="guardarInstancia" class="animate-spin -ml-1 mr-3 h-4 w-4 text-white"
