...
<div style="position: absolute; top: 30mm; right: 4mm;">
    <div class="foto-contenedor">
        <img
            class="foto"
            src="https://ipcgroup.ir/wp-content/uploads/2013/11/farshid.jpg"
            alt=""/>
    </div>
</div>
...
<div style="position: absolute; top: 70mm;">
    ...
    <p style="font-style: italic; line-height: 1.25;">
        El Director (e) de Escuela Profesional de Ingeniería de Sistemas e Informática - Facultad de
        Ciencias - Universidad Nacional Santiago Antúnez de Mayolo. <br><br>
        Hace constar, que:
    </p>

    <h2 style="text-align: center; font-size: 1.175rem;">
        Obregón Alvino Yulisa Ada
    </h2>

    <p style="line-height: 1.25; font-style: italic;">
        Con código N° 151.2502.058, ha culminado satisfactoriamente sus estudios en
        la Escuela Profesional de Ingeniería de Sistemas e Informática, en el periodo de estudios:
    </p>
...
<div style="position:absolute; bottom: -4mm; left: 55mm;">
