                    ...
                    <div class="flex items-center">
                        <div>
                            @if ($session->agent->isDesktop())
                                <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75"
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="text-green-500 font-bold">{{ __('Este dispositivo') }}</span>
                                    @else
                                        {{ __('Ultima sesión iniciado ') }} {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
