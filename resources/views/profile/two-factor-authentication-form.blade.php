<x-jet-action-section>
    ...
    <x-slot name="content">
        @if ($this->enabled)
            <h3 class="text-lg font-bold text-lime-600">
                {{ __('Tienes habilitado la Autenticación de Dos Factores.') }}
            </h3>
        @else
            <h3 class="text-lg font-bold text-gray-700">
                {{ __('Aún no tienes habilitado la Autenticación de Dos Factores.') }}
            </h3>
        @endif
