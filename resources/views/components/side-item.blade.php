...
@php
    $classes = ($active ?? false)
                ? 'bg-gray-100 w-10/12 inline-flex items-center px-3 py-2 border-b-2 lg:border-b-0 lg:border-l-4 border-red-500 font-bold text-sm leading-5 text-gray-700 focus:outline-none focus:border-red-700 transition rounded-t-lg lg:rounded-t-none lg:rounded-r-lg'
