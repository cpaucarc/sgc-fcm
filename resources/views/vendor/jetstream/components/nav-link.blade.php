...
@php
    $classes = ($active ?? false)
                ? 'inline-flex items-center px-1 pt-1 border-b-2 border-rose-500 text-sm font-semibold leading-5 text-gray-700 focus:outline-none focus:border-blue-700 transition'
