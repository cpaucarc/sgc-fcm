...
@php
    $classes = ($active ?? false)
                ? 'inline-flex items-center px-1 pt-1 border-b-2 border-blue-500 text-center text-sm font-semibold leading-5 text-gray-700 focus:outline-none focus:border-red-700 transition'
